package by.mts.brest.java.Homework;
...
class HumanMain {
    public static void main(String[] args) {
        ...
        sanya.name = "Sanya";
        sanya.surname = "Jakimchik";
        sanya.age = 89;
        sanya.setWeight(1);
        sanya.doDiet();

        Human serega = new Human("Serega", "Ivanjukovich");
        serega.age = 52;
        serega.setWeight(2);
        serega.Human();


        Human leha = new Human(76);
        leha.name = "Leha";
        leha.surname = "Ragozinski";
        leha.setWeight(2);

        System.out.println("leha = " + leha);
        System.out.println("sanya = " + sanya);
        System.out.println("serega = " + serega);
