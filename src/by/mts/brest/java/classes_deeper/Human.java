...
public class Human {
    ...
    public static final String humansGreeting = "Приветствую вас дорогие друзья и гости, рад видеть вас!";      // Статическое финализированное поле - ОДНО НЕИЗМЕНЯЕМОЕ для всего класса
    ...
    // МЕТОДЫ, объявляются как МОД_ДОСТУПА ТИМ_ВОЗВРАЩАЕМОГО_ЗНАЧЕНИЯ ИМЯ_МЕТОДА(ПАРАМЕТРЫ) { выполняемый код ... }
